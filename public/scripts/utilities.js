...
const catchPhraseDict = deepFreeze({
  Sun: {
  ...
  Jupiter: {
    ...
    Capricorn:'Behind your wildest dreams lies reality...of course, Jupiter Capricorn',
  ...
  Uranus: {
    ...
    Virgo:'Possibly Vegan/It’s better to burn out than fade away, Virgo Uranus',
